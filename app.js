...
let chess = {
    ...
    states: { // states that have to be kept track of during game
        player: "white",
    ...
    action: { // methods needed for gameplay (data modification and logic, not html)
        ...
        possibleMoves: function(index) {
            ...
            if (color == chess.states.player) { // return possible moves for the piece if the piece is owned by current player
    ...
    render: { // methods used to display data in html
        ...
        update: function() { // updates HTML chess board with the values of pieces from chess.states.state
            for (let i = 0; i < 64; i++) {
                let piece;
